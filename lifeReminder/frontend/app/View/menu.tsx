...
const HomeScreen = ({ route } : {route : any}) => {
  ...
  const irA = (ruta : any) => {
    (navigation as any).navigate(ruta, { pacienteId, nombrePaciente });
  };
  ...
  return (
    <View style={styles.container}>
      ...
      <TouchableOpacity style={[styles.logoutBtn, { backgroundColor: '#E57373' }]} onPress={() => router.push('View/login')}>
